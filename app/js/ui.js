 ...
 *  Такая же функция лежит копиями ещё в девяти экранах — это давний долг,
 *  разбирать его посреди работы над сном не стал; новое берёт отсюда. */
/**
 * Деньги и числа пишутся одинаково во всём приложении. Раньше `money` жил в
