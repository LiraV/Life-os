...
const SCREENS = { day, plans, spheres, habits, health, inside, me, settings, tracker, food, budget };
...
function renderNav() {
  ...
  const drawerScreens = ['spheres', 'food', 'budget', 'habits', 'tracker', 'health', 'settings'];
