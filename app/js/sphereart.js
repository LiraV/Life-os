...
// Пять ключей ниже (Календарь, Дневник, Чай, Карта, Фотоаппарат) раньше
// указывали на портретные иллюстрации встроенных сфер. Сюжет остался тот же,
// файл стал широким и качественнее — у уже выбравших обложку она не подменяется
// на чужую, а просто становится лучше. Сами встроенные сферы не задеты:
// у них путь к картинке свой, в SPHERES.
export const SPHERE_ART = [
  ...
  { key: 'plan',   name: 'Календарь',   src: 'assets/spheres/plan.webp' },
  { key: 'note',   name: 'Дневник',     src: 'assets/spheres/note.webp' },
  { key: 'tea',    name: 'Чай',         src: 'assets/spheres/tea.webp' },
  { key: 'map',    name: 'Карта',       src: 'assets/spheres/map.webp' },
  { key: 'photo',  name: 'Фотоаппарат', src: 'assets/spheres/photo.webp' },
