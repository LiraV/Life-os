...
const SHELL = [
  ...
  './app/css/app.css',
  // Все модули приложения: непереченный подтянется из сети при первом заходе
  // на свой экран, но человека без сети встретит пустотой. Список сверяется
  // проверкой — руками он однажды уже отстал на два десятка файлов.
  './app/js/ai.js',
  './app/js/appicon.js',
  './app/js/avatars.js',
  './app/js/biz.js',
  ...
  './app/js/screens/trips.js',
  './app/js/screens/work.js',
  './app/js/selectors.js',
  './app/js/sphereart.js',
  './app/js/spheregoal.js',
  './app/js/store.js',
  './app/js/sync.js',
  './app/js/tests.js',
  './app/js/theme.js',
  ...
  './manifest-petals.webmanifest',
  './manifest-lotus.webmanifest',
  './manifest-butterfly.webmanifest',
  './manifest-orbit.webmanifest',
  './manifest-heart.webmanifest',
  './manifest-sunrise.webmanifest',
  './manifest-citrus.webmanifest',
];

const MEDIA = [
  './icons/icon-192.png',
  // мелкие обложки — чтобы выбор иконки открывался и без сети
  './icons/pearl-192.png',
  './icons/spiral-192.png',
  './icons/moon-192.png',
  './icons/gate-192.png',
  './icons/petals-192.png',
  './icons/lotus-192.png',
  './icons/butterfly-192.png',
  './icons/orbit-192.png',
  './icons/heart-192.png',
  './icons/sunrise-192.png',
  ...
  './assets/spheres/tea.webp',
  './assets/spheres/map.webp',
  './assets/spheres/photo.webp',
  './assets/spheres/plan.webp',
  './assets/spheres/note.webp',
